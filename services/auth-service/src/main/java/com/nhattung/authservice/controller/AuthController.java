...
import com.nhattung.authservice.service.auth.IntrospectService;
...
public class AuthController {
    ...
    public ApiResponse introspect(@RequestBody IntrospectRequest request) {
            IntrospectResponse response = introspectService.introspect(request);
            return new ApiResponse("Introspect token successfully", response);
    }
